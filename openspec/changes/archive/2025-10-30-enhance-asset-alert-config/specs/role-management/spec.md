...
The system SHALL provide daily wallet transfer limit configuration functionality in the role management parameter configuration modal. 系統必須在角色管理的參數配置彈窗中提供單日錢包轉帳限額的設定功能。
