export default {
  ...
  waitingTimeout: 'Waiting Timeout',
  largeAmountAlert: 'Large Amount Alert',
  settings: 'Settings',
  alertSettings: 'Alert Settings',
  depositAlertThreshold: 'Deposit Greater Than',
  withdrawAlertThreshold: 'Withdraw Greater Than',
  usdtValue: 'USDT Value',
  userId: 'User ID',
  amount: 'Amount',
  settingsSaved: 'Settings Saved',
  withdrawDurationSettings: 'Withdraw Duration Settings',
  notifyTimeout: 'Notify Timeout',
  minutes: 'Minutes',
